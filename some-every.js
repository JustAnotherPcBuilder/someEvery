...
values (more than one element in the array that has the same value as another). If there are any duplicates, the function should return false.
...
function hasNoDuplicates(arr) {
    ...
    return arr.every(function(elem){
        console.log(unique);
        if (unique.includes(elem)) return false;
        unique.push(elem);
        return true;
    })
}
